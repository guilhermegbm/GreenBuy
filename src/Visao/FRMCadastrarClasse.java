 ...
 * @author Guilherme
 */
public class FRMCadastrarClasse extends javax.swing.JFrame {

    /**
     * Creates new form FRMCadastrarClasse
     */
    public FRMCadastrarClasse() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRMCadastrarClasse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRMCadastrarClasse().setVisible(true);
            }
        });
    }
