...
public class FRMCliente extends javax.swing.JFrame {
    ...
    public FRMCliente() {
        ...
        try {
            dados = ControleCliente.listarTodosAtivosJDBC();
            this.preencheTabela();
    ...
    private void initComponents() {
        ...
        cbOpc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos os Ativos", "Código", "Nome", "Todos os inativos" }));
    ...
    private void cbOpcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbOpcActionPerformed
        if (cbOpc.getSelectedIndex() == 0) {
            ...
            try {
                dados = ControleCliente.listarTodosDesligadosJDBC();
                this.preencheTabela();
            } catch (RuntimeException e) {
                JOptionPane.showMessageDialog(null, "Deu ruim: " + e);
            }
    ...
    private void btnDelClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelClienteActionPerformed
        if (ControleFuncionario.verificaFuncionarioLogado()) {
            ...
            if (qtd < 1) {
                ...
                if (dados.get(tableCliente.getSelectedRow()).getSituacaoCli().equals(Cliente.SituacaoCli.DESLIGADO)) {
                    JOptionPane.showMessageDialog(null, "Este cliente já está desativado");
                } else {
    ...
    private void localiza() {
        if ((tfDado.getText().equals("")) || (tfDado.getText().equals("Insira o dado para pesquisa..."))) {
            ...
            if (cbOpc.getSelectedIndex() == 1) {
                try {
                    dados = ControleCliente.listarTudoTodosOuPorCodigoJDBC(Integer.parseInt(tfDado.getText()));
                    this.preencheTabela();
                } catch (RuntimeException e) {
