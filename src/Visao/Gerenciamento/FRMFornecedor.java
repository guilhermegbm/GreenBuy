    ...
    private void btnInativarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInativarActionPerformed
        if (ControleFuncionario.verificaFuncionarioLogado()) {
            ...
            if (qtd < 1) {
                ...
                if (dados.get(tableFornecedor.getSelectedRow()).getSituacaoFor().equals(Fornecedor.SituacaoFor.INATIVO)) {
                    JOptionPane.showMessageDialog(null, "Este fornecedor já está inativo");
                } else {
