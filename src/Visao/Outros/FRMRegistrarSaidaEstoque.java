 ...
 * @author Guilherme
 */
public class FRMRegistrarSaidaEstoque extends javax.swing.JFrame {

    /**
     * Creates new form FRMSaidaEstoque
     */
    public FRMRegistrarSaidaEstoque() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRMRegistrarSaidaEstoque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRMRegistrarSaidaEstoque().setVisible(true);
            }
        });
    }
